...
namespace Tuan5_PhamBachMinhTri.Controllers
{
    public class SachController : Controller
    {
        ...
        public ActionResult Create(FormCollection collection, Sach s)
        {
            ...
            var E_ngaycapnhat = Convert.ToDateTime(collection["ngaycapnhat"]); var E_soluongton = Convert.ToInt32(collection["soluongton"]); if (string.IsNullOrEmpty(E_tensach))
            {
        ...
        public ActionResult Edit(int id, FormCollection collection)
        {
            ...
            var E_hinh = collection["hinh"];
            var E_giaban = Convert.ToDecimal(collection["giaban"]);
            var E_ngaycapnhat = Convert.ToDateTime(collection["ngaycatnhat"]); var E_soluongton = Convert.ToInt32(collection["soluongton"]); E_sach.masach = id;
        ...
        {
            var D_sach = data.Saches.First(m => m.masach == id); return View(D_sach);
        }
        [HttpPost]
